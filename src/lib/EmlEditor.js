...
export default class EmlEditor {
	constructor(textarea, userOptions) {
		 ...
		 */
		initResize = function () {
			var minHeight, maxHeight, minWidth, maxWidth, mouseMoveFunc, mouseUpFunc, grip = dom.createElement('div', {
				...
				}), moveEvents = 'touchmove mousemove', endEvents = 'touchcancel touchend mouseup', startX = 0, startY = 0, newX = 0, newY = 0, startWidth = 0, startHeight = 0, origWidth = dom.width(editorContainer), origHeight = dom.height(editorContainer), isDragging = false, rtl = base.rtl();
		...
		base.wysiwygEditorInsertHtml = function (
			...
			var marker, scrollTop, scrollTo, editorHeight = dom.height(wysiwygEditor);
		...
		base.emoticons = function (enable) {
			...
			if (enable) {
				...
				var emoticons = dom.find(wysiwygBody, 'img[data-emleditor-emoticon]');
