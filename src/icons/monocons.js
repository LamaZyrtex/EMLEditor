...
(function (document, emleditor) {
	...
	var icons = {
		...
		'color': '<text x="50%" y="8" text-anchor="middle" dy=".5ex" font-family="Dejavu Sans, Helvetica, Arial, sans-serif" font-size="13" font-weight="bold">A</text><path class="eml-color" d="M2 13h12v2H2z"/>',
		...
		return {
			create: function (command) {
				if (command in icons) {
					...
					if (command === 'color') {
						colorPath = nodes[command].querySelector('.eml-color');
					}
				}
